...
Version  : 0.9.30
Release  : 48
URL      : https://cran.r-project.org/src/contrib/kernlab_0.9-30.tar.gz
Source0  : https://cran.r-project.org/src/contrib/kernlab_0.9-30.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649036275
