...
Version  : 0.9.28
Release  : 29
URL      : https://cran.r-project.org/src/contrib/kernlab_0.9-28.tar.gz
Source0  : https://cran.r-project.org/src/contrib/kernlab_0.9-28.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573367209
