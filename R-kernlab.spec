...
Source0  : https://cran.r-project.org/src/contrib/kernlab_0.9-33.tar.gz
...
%setup -q -n kernlab
pushd ..
cp -a kernlab buildavx2
popd
pushd ..
cp -a kernlab buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723569606
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/kernlab/libs/kernlab.so
/V4/usr/lib64/R/library/kernlab/libs/kernlab.so
